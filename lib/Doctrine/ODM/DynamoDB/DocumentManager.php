...
use Doctrine\ODM\DynamoDB\Mapping\ClassMetadataInfo;
use Doctrine\ODM\DynamoDB\Mapping\MappingException;
use Doctrine\ODM\DynamoDB\Hydrator\HydratorFactory;
use Doctrine\ODM\DynamoDB\Proxy\ProxyFactory;
use Doctrine\ODM\DynamoDB\Query\FilterCollection;
 ...
 *     $dm = DocumentManager::create($dynamoDbClient, $config);
 */
class DocumentManager implements ObjectManager
{
     ...
     *
     * @var \Doctrine\ODM\DynamoDB\Configuration
     */
    private $config;
     ...
     *
     * @var \Doctrine\ODM\DynamoDB\Mapping\ClassMetadataFactory
     */
     ...
     *
     * @var \Doctrine\ODM\DynamoDB\Query\FilterCollection
     */
    private $filterCollection;

    /**
     * Creates a new Document that operates on the given DynamoDb client
     * and uses the given Configuration.
     *
     * @param \Aws\DynamoDb\DynamoDbClient|null $client
     * @param Configuration|null $config
     * @param \Doctrine\Common\EventManager|null $eventManager
     */
    public function __construct(DynamoDbClient $client, Configuration $config = null, EventManager $eventManager = null)
    {
     ...
     */
    public static function create(DynamoDbClient $client, Configuration $config = null, EventManager $eventManager = null)
    {
    ...
    /**
     * Gets the Dynamodb client instance that this DocumentManager wraps.
     *
     ...
     *
     * @return \Doctrine\ODM\DynamoDB\Mapping\ClassMetadataFactory
     */
     ...
     *
     * @return \Doctrine\ODM\DynamoDB\Hydrator\HydratorInterface
     */
     ...
     *
     * @return \Doctrine\ODM\DynamoDB\SchemaManager
     */
     ...
     * @return \Doctrine\ODM\DynamoDB\Mapping\ClassMetadata
    ...
    {
        /* @var $class \Doctrine\ODM\DynamoDB\Mapping\ClassMetadataInfo */
     ...
     */
    public function find($documentName, $identifier)
    {
        return $this->getRepository($documentName)->find($identifier);
    }
     ...
     *
     * @throws ODMException If the DocumentManager is closed.
     */
    private function errorIfClosed()
    {
        if ($this->closed) {
            throw ODMException::documentManagerClosed();
        }
    }
     ...
     *
     * @return \Doctrine\ODM\DynamoDB\Query\FilterCollection The active filter collection.
     */
